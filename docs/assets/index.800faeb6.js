var Oe=Object.defineProperty,Ae=Object.defineProperties;var Ve=Object.getOwnPropertyDescriptors;var G=Object.getOwnPropertySymbols;var de=Object.prototype.hasOwnProperty,ue=Object.prototype.propertyIsEnumerable;var fe=(t,n,o)=>n in t?Oe(t,n,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[n]=o,y=(t,n)=>{for(var o in n||(n={}))de.call(n,o)&&fe(t,o,n[o]);if(G)for(var o of G(n))ue.call(n,o)&&fe(t,o,n[o]);return t},F=(t,n)=>Ae(t,Ve(n));var pe=(t,n)=>{var o={};for(var r in t)de.call(t,r)&&n.indexOf(r)<0&&(o[r]=t[r]);if(t!=null&&G)for(var r of G(t))n.indexOf(r)<0&&ue.call(t,r)&&(o[r]=t[r]);return o};import{c as a,j as e,m,u as $e,r as h,A as j,a as Se,R as P,P as he,b as Ee,d as U,T as Pe,G as Ie,e as Te,B as He}from"./vendor.1c826dad.js";const Ne=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const d of l)if(d.type==="childList")for(const c of d.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function o(l){const d={};return l.integrity&&(d.integrity=l.integrity),l.referrerpolicy&&(d.referrerPolicy=l.referrerpolicy),l.crossorigin==="use-credentials"?d.credentials="include":l.crossorigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function r(l){if(l.ep)return;l.ep=!0;const d=o(l);fetch(l.href,d)}};Ne();const _={phone:"@media (max-width:767px)"},Le={container:a`
    width: 920px;
    margin-left: auto;
    margin-right: auto;
  `};function S({children:t,className:n}){return e("div",{css:Re.container,className:n},t)}const Re={container:a`
    max-width: 920px;
    margin: 0 auto;
    padding: 0 16px;
    color: #eee;
  ...
  `};function Ge(){return e(m.div,{initial:{opacity:0,y:30},animate:{opacity:1,y:0,transition:{delay:3.8,duration:1.2,ease:"easeOut"}}},e(S,{css:je.views__footer},"MIT Licensed | Copyright \xA9 2018-present Petryshyn Sergii"))}const je={views__footer:a`
  ...
  `,btn_icon:a`
    width: 64px;
    flex: 0 0 64px;
  `,btn__icon:a``};function Ye({form:t}){return e("div",{css:H.state},e("div",{css:H.state__content},e(ye,{title:"Form",content:{touched:t.touched(),dirty:t.dirty(),hasError:t.hasError()}}),e(ye,{title:"Values",content:t.getValues()})))}function ye({title:t,content:n}){return e("div",{css:H.state__section},e("div",{css:H.state__sectionTitle},t,":"),e("div",{css:H.state__sectionContent},JSON.stringify(n,(o,r)=>r===void 0?"undefined":r,2).replaceAll('": "undefined"','": undefined')))}const H={state:a`
    flex: 0.6;
    overflow: hidden;
    padding: 24px 32px;
...
export function TextField({ field }: Props) {
  ...
  `};console.log("CLIENT: ","/useform/");Te.hydrate(e(He,{basename:"/useform/"},e(yt,null)),document.getElementById("root"));
